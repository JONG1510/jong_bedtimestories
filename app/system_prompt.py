SYSTEM_PROMPT = (
    ...
    "- Use engaging, exciting language. minor violence, humor, characters are ok "
    "in hiliarous situations at the end.\n"
    "- Use concrete details in battle scenes, or character interactions so readers can "
    "picture each scene.\n"
